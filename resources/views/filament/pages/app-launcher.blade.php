...
<style>
    ...
    .launcher-tile:hover::after { opacity: 0.04; }
    ...
    .launcher-tile.featured::after { display: none; }
    .launcher-tile.featured::before { display: none; }
    ...
    .launcher-tile.featured .tile-text { text-align: right; }
    .launcher-tile.featured .tile-title {
        font-size: 1.2rem;
        color: #F4A623;
        margin-bottom: 0.2rem;
    }
    .launcher-tile.featured .tile-subtitle { color: rgba(255,255,255,0.65); }
    ...
    .launcher-tile:not(.featured):hover .tile-enter { opacity: 1; }
    ...
    @media (max-width: 640px) {
        ...
        .launcher-tile.featured .featured-arrow { margin: 0 auto; }
    ...
    .dark .tile-title { color: #F1F5F9; }
    .dark .launcher-tile.featured { background: linear-gradient(135deg, #0F172A 0%, #0C4A6E 100%); }
</style>
